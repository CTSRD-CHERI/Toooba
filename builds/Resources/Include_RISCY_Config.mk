...
DATA_PREFETCHER_TYPE ?= CDP_NAIVE
...
ifeq (,$(filter $(DATA_PREFETCHER_TYPE),MARKOV MARKOV_ON_HIT MARKOV_ON_HIT_2 BLOCK STRIDE STRIDE_ADAPTIVE CDP CDP_NAIVE SELECTIVECDP))
